...
class AcornInstallCommand extends Command
{
    ...
    {
        $path = InstalledVersions::getInstallPath('Utoai/Monk');
        $path = dirname($path, 5);
        ...
        $script = 'Utoai\\Monk\\ComposerScripts::postAutoloadDump';
    ...
    protected function askToInitialize(): void
    {
        ...
        if ($this->option('init') || confirm(
            ...
            $this->callSilent('Monk:init', ['--base' => $this->getLaravel()->basePath()]);
        }
    }
    ...
    protected function askToStar(): void
    {
        ...
        if (confirm(
            ...
            match (PHP_OS_FAMILY) {
                'Darwin' => exec('open https://github.com/utoai/monk'),
                'Linux' => exec('xdg-open https://github.com/utoai/monk'),
                'Windows' => exec('start https://github.com/utoai/monk'),
            };
